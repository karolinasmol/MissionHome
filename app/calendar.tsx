...
// czy misja „występuje” w danym dniu
...
export default function CalendarScreen() {
  ...
  /* ------------------ Kalendarz (jak WEB: staty per dzień) ------------------ */
    ...
    return (
      ...
      >
        {avatarUrl ? (
          ...
          <Text style={{ color: colors.text, fontWeight: "900", fontSize: Math.max(10, size * 0.36) }}>
            {initials}
          </Text>
        )}
      </View>
  ...
  const StatMini = ({
    ...
    return (
      <View style={[styles.statMiniCompact, { borderColor: colors.border, backgroundColor: colors.bg }]}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Ionicons name={icon} size={15} color={tint || colors.textMuted} />
          <Text style={{ color: colors.text, fontWeight: "900", fontSize: 16, marginLeft: 8 }}>
            {value}
          </Text>
        </View>

        <Text style={{ color: colors.textMuted, fontWeight: "900", fontSize: 10, marginTop: 2 }}>
          {label}
        </Text>
      </View>
    );
    ...
    return (
      <View style={styles.cardHeaderRow}>
        <View style={{ flex: 1 }}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            {!!icon && (
              <View style={[styles.iconPill, { borderColor: colors.border, backgroundColor: colors.bg, marginRight: 8 }]}>
            ...
            <View style={{ marginBottom: 14 }}>
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <View style={[styles.badgePillSmall, { borderColor: colors.border, backgroundColor: colors.bg }]}>
                    <Ionicons name="pulse-outline" size={13} color={colors.textMuted} style={{ marginRight: 6 }} />
                ...
                <Text style={{ color: colors.textMuted, fontSize: 11, marginTop: 8 }}>
                  ...
                  {"  "}•{"  "}
                  Delegowane:{" "}
                  <Text style={{ color: colors.text, fontWeight: "900" }}>{delegatedForSelectedDay.length}</Text>
                </Text>

                {/* ✅ zawsze 3 w jednym rzędzie (jak WEB) */}
                <View style={{ flexDirection: "row", marginTop: 10 }}>
                  <View style={{ flex: 1, marginRight: 10 }}>
                    <StatMini icon="checkmark-circle-outline" value={dayDone} label="wykonane" tint="#16a34a" />
                  </View>
                  ...
                  <View style={{ flex: 1 }}>
                    <StatMini icon="people-outline" value={delegatedForSelectedDay.length} label="delegowane" />
                  </View>
                </View>
            ...
            >
              <View style={styles.monthHeader}>
                ...
                <View style={{ alignItems: "center" }}>
                  <Text style={{ color: colors.text, fontSize: 16, fontWeight: "900", textTransform: "capitalize" }}>
              ...
              <SectionHeader
                ...
                right={
                  loading ? (
                    ...
                    <View style={[styles.badgePill, { borderColor: "#22c55e66", backgroundColor: "#22c55e22" }]}>
                  ...
                  {myPendingMissions.length > 0 && (
                    <View style={{ marginBottom: 10 }}>
                      ...
                      {myPendingMissions.map((m: any) => {
                        ...
                        return (
                          <View key={m.id} style={[styles.missionRow, { borderColor: colors.border, backgroundColor: colors.bg }]}>
                            <View
                              style={{
                                width: 28,
                                height: 28,
                  ...
                  {myCompletedMissions.length > 0 && (
                    <View>
                      ...
                      {myCompletedMissions.map((m: any) => {
                        ...
                        return (
                          <View key={m.id} style={[styles.missionRow, { borderColor: "#22c55e55", backgroundColor: "#22c55e12" }]}>
                            <View
                              style={{
                                width: 28,
                                height: 28,
...
const styles = StyleSheet.create({
  ...
  // ✅ FIX: zawsze 3 obok siebie (bez spadania w dół)
  statMiniCompact: {
    flex: 1,
    borderWidth: 1,
    borderRadius: 14,
