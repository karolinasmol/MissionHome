    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <SectionCard>
          ...
          <P>
            1. Niniejszy regulamin („Regulamin”) określa zasady korzystania z systemu MissionHome
            („System”), dostępnego w formie aplikacji mobilnej oraz aplikacji internetowej,
            świadczonego drogą elektroniczną przez przedsiębiorcę prowadzącego jednoosobową
            działalność gospodarczą pod nazwą MissionHome, z siedzibą w Gdańsku (adres do uzupełnienia),
            NIP xxx, adres kontaktowy: xxx („Usługodawca”).
          </P>

          <P>
            2. System MissionHome umożliwia organizację zadań domowych, planowanie obowiązków,
            współpracę w rodzinnych grupach użytkowników oraz korzystanie z systemu misji, poziomów
            i punktów doświadczenia (EXP).
          </P>
        ...
        <SectionCard>
          ...
          <P>
            1. Aplikacja umożliwia korzystanie z funkcji takich jak: tworzenie zadań i obowiązków,
            planowanie misji i celów, otrzymywanie propozycji codziennych zadań,
            zdobywanie punktów doświadczenia (EXP), rywalizacja w rankingach, tworzenie Rodzin
            i zarządzanie ich członkami, konwersacje tekstowe z członkami Rodziny.
          </P>
        ...
        <SectionCard>
          ...
          <P>
            2. Zabrania się publikowania treści niezgodnych z prawem, obraźliwych, naruszających
            prywatność, zawierających dane wrażliwe lub spam.
          </P>
        ...
        <SectionCard>
          ...
          <P>
            3. Funkcje Rodziny - np. tworzenie Rodziny, wiadomości, statystyki grupowe,
        ...
        <SectionCard>
          ...
          <P>
            3. Usługodawca nie ponosi odpowiedzialności za niewłaściwe korzystanie z Aplikacji,
            spory między Użytkownikami, utratę danych wynikającą z błędów technicznych ani szkody
            powstałe wskutek działania siły wyższej.
          </P>
          ...
          <P>
            5. Usługodawca nie odpowiada za utratę danych spowodowaną awarią Firebase
            lub usług chmurowych.
          </P>
        ...
        <SectionCard>
          ...
          <P>
            7. Przetwarzane dane mogą obejmować dane logowania, dane o użytkowaniu Aplikacji,
            dane o zakupach i treści użytkownika.
          </P>
        ...
        <SectionCard>
          ...
          <P>
            ...
            w szczególności: zmian prawa, zmian funkcjonalnych Aplikacji, zmian organizacyjnych,
