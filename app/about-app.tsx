  ...
  const InfoRow = ({
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={{ color: ui.text, fontSize: 13, fontWeight: "900" }}>
          {value}
        </Text>
      </View>
    </View>
      ...
      >
        ...
        >
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                Kilka słów o tym, czym jest MissionHome i jak pomoże Ci w
                ogarnianiu domu.
              </Text>
            </View>
        ...
        <SectionCard>
          ...
          >
            ...
            działa. Zamiast zwykłej listy „to-do” dostajesz system misji, poziomów
            i EXP, który zmienia codzienność w coś, co naprawdę chce się robić.
          </Text>
          ...
          >
            ...
            żeby domowe obowiązki były prostsze, bardziej intuicyjne i mniej
            stresujące.
          </Text>
        </SectionCard>
        ...
        <SectionCard>
          ...
          <Bullet icon="infinite-outline">
            dla par i rodzin, które chcą jasno dzielić obowiązki, zamiast kłócić się
            o to, kto znowu wynosi śmieci,
          </Bullet>
          <Bullet icon="happy-outline">
            dla rodziców, którzy chcą w prosty sposób wprowadzić dzieci w domowe
            zadania,
          </Bullet>
          <Bullet icon="compass-outline">
            dla osób, które lubią mieć plan i widzieć realny postęp - także w
            codziennych obowiązkach,
          </Bullet>
          <Bullet icon="sparkles-outline">
            dla tych, którzy potrzebują delikatnej motywacji do sprzątania, zmywania
            i innych „ulubionych” aktywności 😉
          </Bullet>
        </SectionCard>
        ...
        <SectionCard highlight>
          ...
          <Bullet icon="sunny-outline">
            Proponowanie misji dnia - przy pierwszym logowaniu danego dnia aplikacja
            podpowiada gotowe zadania do ogarnięcia i pomaga zacząć z energią.
          </Bullet>
        ...
        <SectionCard>
          ...
          >
            MissionHome rozwijamy małymi, regularnymi krokami - dlatego możesz trafić na
            drobne błędy albo elementy, które jeszcze dopieszczamy.
          </Text>
