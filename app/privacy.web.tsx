      ...
      >
        ...
        <SectionCard>
          ...
          <Bullet>
            ...
            adres IP (w logach bezpieczeństwa), informacje o próbach
            logowania, tokeny autoryzacyjne.
          </Bullet>
          ...
          <Bullet>
            <Text style={{ fontWeight: "700" }}>Dane komunikacyjne:</Text>{" "}
            treść zgłoszeń do obsługi użytkownika oraz prowadzona
            korespondencja.
          </Bullet>
        </SectionCard>
        ...
        {/* 3. CELE */}
        <SectionCard>
          <SectionTitle icon="sparkles-outline" title="3. Cele przetwarzania danych osobowych" />
          ...
          <Bullet>
            przesyłanie informacji o nowych funkcjach lub materiałach edukacyjnych - wyłącznie
            po uzyskaniu odrębnej zgody.
          </Bullet>
        </SectionCard>
        ...
        <SectionCard>
          ...
          <Bullet>
            Operatorzy płatności przetwarzą dane płatnicze jako niezależni administratorzy danych.
            Administrator otrzymuje wyłącznie informacyjne niezbędne do potwierdzenia zakupu
            oraz statusu Subskrypcji Premium.
          </Bullet>
          <Bullet>
        ...
        <SectionCard>
          ...
          <Bullet>
            Aplikacje mobilne mogą wykorzystywać identyfikatory aplikacyjne oraz dane
            diagnostyczne zgodnie z zasadami iOS i Android.
          </Bullet>
        </SectionCard>
        ...
        <SectionCard>
          <SectionTitle
            icon="cloud-outline"
            title="7. Odbiorcy danych osobowych"
          />
        ...
        <SectionCard>
          <SectionTitle
            icon="happy-outline"
            title="12. Korzystanie z Systemu przez dzieci"
          />
        ...
        <SectionCard>
          <SectionTitle
            ...
            title="13. Zmiany Polityki Prywatności i Cookies"
          />
